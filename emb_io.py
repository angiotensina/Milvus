...
######################### CARGAR EL DOCUMENTO #########################
def chunks_from_txtfile(String_input):
   # load the document and split it into chunks
    
    # Cargar el documento
    # Crear un documento con el contenido leído
    document = Document(page_content=String_input, metadata={"source": "StringIO"})
...
def main():
    ...
    txt=parse_document(file)
    vectorstore = embed_documents_to_milvus(txt=txt, uri="http://localhost:19530", db_name="tst_db", collection_name="tst_col")
